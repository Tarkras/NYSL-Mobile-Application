      ...
      <v-container px-3 py-0 fill-height>
        <v-layout>
          ...
          <v-card width="100%" height="100%">
            ...
            <v-card class="scrollable border-card" height="340" max-width="100%" id="scrollable">
...
export default {
  ...
  methods: {
    ...
    general() {
      ...
      this.$emit("general", "app-post-general")
    },
    scrollToEnd() {
...
.v-text-field.field--enclosed > .v-input__control > .v-input__slot {
