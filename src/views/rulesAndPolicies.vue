  ...
  <v-container>
    ...
    <v-container px-2>
      <v-layout pb-2 column align-center class="text-xs-center">
        ...
        <v-layout pb-2>
          <h2 class="title font-weight-medium">Rules of Play &amp; Policies</h2>
        </v-layout>
        <p class="body-2">
      ...
      <v-layout column pb-3>
        <h2 class="text-uppercase title font-weight-bold">Sportsmanship</h2>
        <ul>
          <li>
            <p class="body-1">
      ...
      <v-layout pb-3 column>
        <h2 class="text-uppercase title font-weight-bold">
          Fifa Field Regulations
        </h2>
        <ol>
          <li>
            <p class="body-1">
              <strong class="text-uppercase">Dimensions.</strong> FIFA Law 1
              provides for flexible external field dimensions within a given
              maximum and minimum width and length. These dimensions should be
              adhered to for all fields used by teams under 12 and older.
            </p>
          </li>
          <li>
            <p class="body-1">
              <strong class="text-uppercase">Competition Fields.</strong>
          ...
          <li>
            <h3 class="body-1">
              <strong class="text-uppercase"
                >Fields Used By Young Age Groups.</strong
              >
            </h3>
            <ol type="a">
              <li>
          ...
          <li>
            <h3 class="body-1">
              <strong class="text-uppercase">Team Bench Areas</strong>
            </h3>
            <ol type="a">
              <li>
                <span class="body-1">Recreation &amp; District Programs</span>
                <ul>
                  <li>
                    <p class="body-1">
              ...
              <li>
                <span class="body-1">State Competition League Only</span>
                <ul>
                  <li>
                    <p class="body-1">
      ...
      <v-layout pb-3 column>
        <h2 class="text-uppercase title font-weight-bold">Equipment</h2>
        <ul>
          <li>
            <p class="body-1">
      ...
      <v-layout pb-3 column>
        <h2 class="text-uppercase title font-weight-bold">Number of Players</h2>
        <ul>
          <li>
            <p class="body-1">
              <strong class="text-uppercase">Team Size.</strong>
          ...
          <li>
            <p class="body-1">
              <strong class="text-uppercase">Size of Age Group Teams.</strong>
      ...
      <v-layout pb-3 column>
        <h2 class="text-uppercase title font-weight-bold">Substitutions</h2>
        <ul>
          <li>
            <p class="body-1">
            ...
            <ol>
              <li>
                <p class="body-1">Prior to a throw-in your favor.</p>
              </li>
              <li>
                <p class="body-1">Prior to a goalkick by either team.</p>
              </li>
              <li>
                <p class="body-1">After a goal by either team.</p>
              </li>
              <li>
                <p class="body-1">
      ...
      <v-layout pb-3 column>
        <h2 class="text-uppercase title font-weight-bold">All-Play</h2>
        <ul>
          <li>
            <p class="body-1">
      ...
      <v-layout pb-3 column>
        <h2 class="text-uppercase title font-weight-bold">Mixed Teams</h2>
        <ul>
          <li>
            <p class="body-1">
              <strong class="text-uppercase"
                >Girls Playing On Boys' Teams.</strong
              >
          ...
          <li>
            <p class="body-1">
              <strong class="text-uppercase">Types of Teams.</strong>
      ...
      <v-layout pb-3 column>
        <h2 class="text-uppercase title font-weight-bold">Game Termination</h2>
        <ul>
          <li>
            <p class="body-1">
